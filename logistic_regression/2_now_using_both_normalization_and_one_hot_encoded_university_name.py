...
def fit_logistic(X, y, comment, use_x_normalization):
    print("------------------------------")
    print(comment)
    print("------------------------------")
    np.random.seed(0)
...
def main():
    ...
    fit_logistic(X_train, y_train, "Without normalization on X", False)
    fit_logistic(X_train, y_train, "With normalization on X", True)
